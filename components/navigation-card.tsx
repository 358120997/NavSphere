    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <Card
            className={[
              'group relative overflow-hidden rounded-lg border border-[#9da8b1]/75 shadow-[0_10px_26px_rgba(42,50,58,0.12)] transition-all duration-200 ease-out',
              'hover:-translate-y-1 hover:border-[#6f7c87] hover:shadow-[0_18px_40px_rgba(32,40,48,0.24)] hover:ring-1 hover:ring-[#6f7c87]/50',
          ...
          >
            <div
              className={[
                'pointer-events-none absolute inset-x-0 top-0 h-1 opacity-80 transition-all duration-200 group-hover:h-1.5 group-hover:opacity-100',
                pastel?.accent || 'bg-[#6f879b]',
              ].join(' ')}
            />
            <div className="pointer-events-none absolute inset-0 bg-white/0 transition-colors duration-200 group-hover:bg-white/16" />
            <Link
              href={item.href}
              target="_blank"
